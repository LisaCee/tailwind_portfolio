			...
			<div className="grid grid-cols-1 pt-5 gap-y-5 sm:grid-cols-2">
				<div className="grid grid-cols-2 grid-rows-1 lg:justify-items-center">
					...
					<div className="sm:mb-5 lg:justify-self-start">
						<ul>
							<li><span className="text-pink-700">&#9733;</span>  PHP</li>
							<li><span className="text-pink-700">&#9733;</span>  JavaScript</li>
							<li><span className="text-pink-700">&#9733;</span>  React</li>
							<li><span className="text-pink-700">&#9733;</span>  Python</li>
						</ul>	
					</div>
				</div>
				...
				<div className="grid grid-cols-2 grid-rows-1 lg:justify-items-center">
					...
					<div className="lg:justify-self-start">
						<ul>
							<li><span className="text-pink-700">&#9733;</span>  WordPress</li>
							<li><span className="text-pink-700">&#9733;</span>  Bootstrap</li>
							<li><span className="text-pink-700">&#9733;</span>  Sass</li>
							<li><span className="text-pink-700">&#9733;</span>  Git &#38; Github</li>
						</ul>
					</div>
				</div>
				...
				<div className="grid grid-cols-2 grid-rows-1 lg:justify-items-center">
					...
					<div className="lg:justify-self-start">
						<ul>
							<li><span className="text-pink-700">&#9733;</span>Remote</li>
							<li><span className="text-pink-700">&#9733;</span>Asynchronous</li>
							<li><span className="text-pink-700">&#9733;</span>Sass</li>
							<li><span className="text-pink-700">&#9733;</span>Git &#38; Github</li>
						</ul>
					</div>
				...
				<div className="grid grid-cols-2 grid-rows-1 lg:justify-items-center">
					...
					<div className="lg:justify-self-start">
						<ul>
							<li><span className="text-pink-700">&#9733;</span>  iThemes <span className="text-sm">(2021)</span></li>
							<li><span className="text-pink-700">&#9733;</span>  Sandhills Dev <span className="text-sm">(2020-2021)</span></li>
							<li><span className="text-pink-700">&#9733;</span>  KCLS <span className="text-sm">(2005-2020)</span></li>
						</ul>
					</div>
				</div>
			</div>
